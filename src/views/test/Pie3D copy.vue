<template>
  <div ref="chart" style="width: 600px; height: 400px" class="chart-bg"></div>
</template>
...
export default {
  ...
  methods: {
    ...
    initOption() {
      ...
      this.option = {
        backgroundColor: {
          image: require("@/assets/bigScreen/pumpOperation/pie3D_bg.png"), // 或者直接 URL
          repeat: "no-repeat" // 不平铺
          // 可以配合 size/position 控制
        ...
        title: [
          {
            ...
            top: "40%",
            text: total,
            textStyle: { color: "#fff", fontSize: 42, fontWeight: "bold" }
          },
          {
            x: "center",
            top: "48%",
...
.chart-bg {
  width: 600px;
  height: 400px;
  background: url('~@/assets/bigScreen/pumpOperation/pie3D_bg.png') no-repeat center/cover;
}
</style>

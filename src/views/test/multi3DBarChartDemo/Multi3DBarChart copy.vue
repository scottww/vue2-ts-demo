        ...
        series: [
          {
            ...
            itemStyle: {
              normal: {
                color: (params) => this.barTopColor[params.dataIndex]
              }
            },
            symbolPosition: "end",
            data: seriesData1
          ...
          },
          {
            ...
            itemStyle: {
              normal: {
                color: "transparent",
                borderColor: this.barTopColor[0],
                borderWidth: 2
              }
            },
            data: seriesData1
              ...
              normal: {
                color: (params) =>
                  new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                    { offset: 1, color: this.barTopColor[params.dataIndex] },
                    { offset: 0, color: this.barBottomColor[params.dataIndex] }
                  ]),
                opacity: 0.8
              }
            },

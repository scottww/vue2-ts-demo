  ...
  methods: {
      ...
      const option = {
        ...
        yAxis: [
          ...
          },
          {
            ...
            axisLabel: { color: "rgba(255, 255, 255, 0.7)" },
            splitLine: { lineStyle: { color: "rgba(255, 255, 255, 0.1)" } },
            nameTextStyle: { color: "rgba(255, 255, 255, 0.7)", align: "right" }
          }
        ],
        series: [
          {
    ...
    updateChartData(newData) {
      if (this.chartInstance && newData) {
        ...
        this.realTimeWaterLevel =
          newData.realTimeWaterLevel || this.realTimeWaterLevel;
        this.forecastWaterLevel =
          newData.forecastWaterLevel || this.forecastWaterLevel;
        this.forecastRainfall =
          newData.forecastRainfall || this.forecastRainfall;
        this.warningWaterLevel =
          newData.warningWaterLevel !== undefined
            ? newData.warningWaterLevel
            : this.warningWaterLevel;

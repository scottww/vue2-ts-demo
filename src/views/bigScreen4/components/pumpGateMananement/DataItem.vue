    ...
    <div class="data-content">
      ...
      <div class="data-top" :style="{ backgroundImage: `url(${topBg})` }">
        <div class="data-bottom-left">
          <span class="data-label">{{ top.label }}</span>
          <span class="data-value">{{ top.value }}</span>
        </div>
        <span class="data-unit">{{ top.unit }}</span>
      </div>
      <!-- 下部分，单位靠右 -->
...
export default {
  ...
  props: {
    ...
    imgTextPosition: { type: String, default: "center" }, // top/center/bottom
    top: {
      type: Object,
      required: true,

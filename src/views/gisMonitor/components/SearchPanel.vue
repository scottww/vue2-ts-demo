...
import { generateData } from "../generateDataHelper.js";
export default {
  name: "CombinedSearch",
  ...
  data() {
    return {
      ...
      hoverIndex: null,
      typeOptions: [
        { value: "fuzzySearch", label: "模糊搜索" },
        { value: "irrigationZone", label: "灌片定位" },
      ],
      searchData: {
        fuzzySearch: generateData("点位", 5000, 1),
        irrigationZone: generateData("灌片", 1000, 1),
      }
    };
  },
  computed: {

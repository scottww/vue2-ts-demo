...
export default {
  ...
  data() {
    return {
      todos: [
        { id: 1, text: 'Learn VueJs', completed: true },
        { id: 2, text: 'Code a todo list', completed: false },
        { id: 3, text: 'Learn something else', completed: false }
      ],
      newTodoText: '',
  ...
  methods: {
    ...
    onSortToggleChange() {
      // 排序切换时不需要额外操作，displayItems计算属性会自动更新
    }
  }
}
</script>
